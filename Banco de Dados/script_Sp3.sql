...
('João Paula', '98765432000112', 'Dica Enterprises', 'jp@mail.com', 'ficaadica06', '08021570', 'Rua dos Panos', 814, NULL, 'Centro', 'Campinas', 'SP', 'Lavoura'),
...
('João Paula', 'jp@mail.com', '030.000.000', 'senha_nova', 'Ativo', null, 1);
...
('SENS-003', -15.491804, -48.421441, 3, 3),  
('SENS-004', -20.442778, -54.646389, 4, 4); 
...
('Em uso', 'Sem falhas', 'Sensor operando', 3),
('Para uso', 'Sem falhas', 'Pronto para instalação no lote 4.', 4);
